...
WABeres menyediakan SDK resmi untuk **JavaScript/TypeScript** yang dapat langsung 
...
<Note>
  ...
  repository resmi WABeres. Repository bersifat **open source**, kontribusi di persilahkan.
</Note>

<Card title="WABeres JS/TS SDK" icon="github" href="https://github.com/WABeres/waberes-js" horizontal>
...
| `X-Device-Id` | Device ID sesi WhatsApp yang aktif |
